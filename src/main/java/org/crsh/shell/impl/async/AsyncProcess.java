...
public class AsyncProcess implements ShellProcess {
     ...
     * .
     */
    public ShellProcessContext context = new ShellProcessContext() {
    ...
    public void execute(ShellProcessContext processContext) {
                ...
                try {
                    ...
                    if (response == null) {
                        ...
                        try {
                            ...
                            log.error("Unexpected throwable when executing process", t);
        ...
        synchronized (shell.lock) {
            if (!shell.closed) {
                //log.info("submit task ==> " + shell);
                future = shell.executor.submit(task);
//            try {
//                future.get();
//            } catch (Exception e) {
//                log.error("error", e);
