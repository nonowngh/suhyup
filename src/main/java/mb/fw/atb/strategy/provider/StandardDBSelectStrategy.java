...
import mb.fw.atb.schema.provider.StandardDBSelectStrategySchema;
...
@Component(value = "StandardDBSelectStrategy")
@Slf4j
public class StandardDBSelectStrategy extends ATBStrategy {
    ...
    public Specifications specifications() {
        return StandardDBSelectStrategySchema.specifications();
    }
    ...
    public Object onMessageData(IFContext context, String txid, String eventDt, Object data, Map<String, String> propMap) throws Exception {
        ...
        try {
            selectList = dbTransactionService.select(context.getInterfaceId() + ".SELECT", context, dataMap);
        } catch (Exception e) {
            ...
            propMap.put(THeader.RECEIVER_RESULT_MSG.key(), "DB SELECT FAILURE");
            retMap.put("dataList", Lists.newArrayList());
        ...
        retMap.put("dataList", selectList);
