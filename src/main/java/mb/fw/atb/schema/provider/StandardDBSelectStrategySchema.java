...
public class StandardDBSelectStrategySchema {
    ...
    public static Specifications specifications() {
        String name = "DB Select";
        String nameKor = "DB 조회";
        String description = "DB에 데이터를 조회하는 전략입니다.";
        String version = "1.0";

      /*
      - interfaceId: IF_REST_DB_02
        actionType: CUSTOMIZE
        strategy: StandardDBSelectStrategy
