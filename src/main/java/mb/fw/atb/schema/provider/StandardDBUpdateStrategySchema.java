...
public class StandardDBUpdateStrategySchema {
    ...
    public static Specifications specifications() {
        String name = "DB Update";
        String nameKor = "DB 수정";
        String description = "DB에 데이터를 업데이트하는 전략입니다.";
        String version = "1.0";

      /*
         - interfaceId: IF_REST_DB_03
        actionType: CUSTOMIZE
        strategy: StandardDBUpdateStrategy
