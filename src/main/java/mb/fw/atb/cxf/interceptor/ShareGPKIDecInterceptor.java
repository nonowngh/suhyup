...
public class ShareGPKIDecInterceptor extends AbstractPhaseInterceptor<SoapMessage> {
    ...
    public void handleMessage(SoapMessage message) throws SoapFault {
        ...
        try {
            ...
            try {
                decoded = newGpkiUtil.decode(encoded);
            ...
            //암호화된 메시지로 다시 설정
            addDocument(soapbody, operation, prefix, suffix, decrypted);
